  ...
  return (
    <div className={"mx-w-6xl mx-auto px-4 py-12"}>
      <div className="text-center mb-16">
        <h1 className={"text-4xl md:text-6xl font-bold text-gray-900"}>Welcome to MyWebsite</h1>
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="italic text-gray-600">Build with Modern Tech for Optimal Performance</p>
        </div>
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
        ...
        <div className="text-center p-6 bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <p className="italic text-gray-600">Works perfectly on all screens and sizes</p>
        </div>
      </div>
    </div>
  );
